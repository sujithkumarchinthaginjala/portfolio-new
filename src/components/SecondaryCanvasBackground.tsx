...
export const SecondaryCanvasBackground: React.FC = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 1; i <= framesCount; i++) {
      ...
      img.src = `/ezgif-3f45a0247563a9a7-jpg/ezgif-frame-${paddedIndex}.jpg`;
      images.push(img);
    ...
    const render = () => {
      ...
      if (containerRef.current) {
        ...
        if (scrollableDistance > 0) {
          ...
          const frameIndex = Math.floor(scrollFraction * framesCount);
          const safeFrameIndex = Math.min(framesCount - 1, frameIndex);
